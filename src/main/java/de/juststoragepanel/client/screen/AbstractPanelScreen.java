...
public abstract class AbstractPanelScreen<T extends AbstractPanelMenu> extends net.minecraft.client.gui.screens.inventory.AbstractContainerScreen<T> {
    ...
    public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        this.extractExtraBackground(guiGraphics, x, y, mouseX, mouseY);
    }

    @Override
    protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        guiGraphics.text(this.font, this.title, 10, 8, 0xFFF4F1DE, false);
        guiGraphics.text(this.font, this.playerInventoryTitle, this.inventoryLabelX, this.inventoryLabelY, 0xFFD9D2B6, false);
        ...
        guiGraphics.text(this.font, pageText, pageX, 11, 0xFFE07A5F, false);
    }

    protected abstract void extractExtraBackground(GuiGraphicsExtractor guiGraphics, int leftPos, int topPos, int mouseX, int mouseY);
    ...
    private void drawPlayerInventory(GuiGraphicsExtractor guiGraphics, int x, int y) {
    ...
    protected final void drawSlotGrid(GuiGraphicsExtractor guiGraphics, int x, int y, int columns, int rows) {
    ...
    protected final void drawSlot(GuiGraphicsExtractor guiGraphics, int x, int y) {
    ...
    protected final void drawPanel(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height, int outerColor, int borderColor, int innerColor) {
